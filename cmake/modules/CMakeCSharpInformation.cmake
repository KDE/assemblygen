...
macro(GET_LIBRARY_OUTPUT_DIR var)
    if (NOT LIBRARY_OUTPUT_PATH)
        ...
        set(${var} ${LIBRARY_OUTPUT_PATH}/${CMAKE_CFG_INTDIR})
...
macro(GET_EXECUTABLE_OUTPUT_DIR var)
    if (NOT EXECUTABLE_OUTPUT_PATH)
        ...
        set(${var} ${EXECUTABLE_OUTPUT_PATH}/${CMAKE_CFG_INTDIR})
...
function(csharp_add_executable target)
    ...
    if (CMAKE_BUILD_TYPE STREQUAL "Debug" OR CMAKE_BUILD_TYPE_INIT STREQUAL "Debug")
        list(APPEND _csc_opts "/define:DEBUG")
        list(APPEND _csc_opts "/debug")
    endif (CMAKE_BUILD_TYPE STREQUAL "Debug" OR CMAKE_BUILD_TYPE_INIT STREQUAL "Debug")
