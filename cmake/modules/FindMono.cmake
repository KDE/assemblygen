...
IF (MONO_EXECUTABLE AND DMCS_EXECUTABLE AND GACUTIL_EXECUTABLE AND SN_EXECUTABLE)
	SET (MONO_FOUND TRUE CACHE INTERNAL "")
ENDIF (MONO_EXECUTABLE AND DMCS_EXECUTABLE AND GACUTIL_EXECUTABLE AND SN_EXECUTABLE)
...
IF (NOT Mono_FIND_QUIETLY)
    ...
    MESSAGE(STATUS "Path of sn: ${SN_EXECUTABLE}")
...
MARK_AS_ADVANCED(MONO_EXECUTABLE DMCS_EXECUTABLE GACUTIL_EXECUTABLE SN_EXECUTABLE)
